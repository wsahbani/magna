...
@Module({
  ...
  providers: [ProcessMapService, ProcessMapRepository, ProcessMapFlowService, ProcessMapValidationService, PrismaService],
  exports: [ProcessMapService, ProcessMapRepository, ProcessMapFlowService, ProcessMapValidationService],
})
