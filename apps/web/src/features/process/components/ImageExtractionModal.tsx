 ...
 * Modal pour uploader une image et extraire un Process avec IA vision
 */
...
import { useExtractProcessFromImage } from '../hooks/useExtractProcessFromImage';
...
export function ImageExtractionModal({
  ...
  const extractMutation = useExtractProcessFromImage();
  ...
  const handleExtract = useCallback(async () => {
    ...
    try {
      ...
      onSuccess({
        ...
        proceduresCreated: result.data.proceduresCreated,
  ...
  }, [selectedFile, processId, replaceExisting, description, extractMutation, onSuccess, onOpenChange]);
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-full max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Uploadez une image contenant un diagramme de processus. L'IA analysera l'image et extraira automatiquement les procédures, tâches, événements et gateways.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            <Label>Image du diagramme de processus</Label>
            {!selectedFile ? (
              <div
          ...
          <div className="space-y-2">
            ...
            <Textarea
              id="description"
              placeholder="Exemple: Processus de recrutement avec sélection, entretien et embauche"
              value={description}
            ...
            <div className="flex items-start gap-2 p-3 bg-green-50 border border-green-200 rounded-lg">
              ...
              <div className="flex-1">
                ...
                <BodySmall className="text-green-600">
                  {extractMutation.data.data.proceduresCreated} procédure(s),{' '}
                  {extractMutation.data.data.tasksCreated} tâche(s),{' '}
                  {extractMutation.data.data.eventsCreated} événement(s),{' '}
