 ...
 * Modal pour uploader une image et extraire une ProcessMap avec IA vision
 */
...
import { useExtractProcessMapFromImage } from '../hooks/useExtractProcessMapFromImage';
...
export function ImageExtractionModal({
  ...
  const extractMutation = useExtractProcessMapFromImage();
  ...
  const handleExtract = useCallback(async () => {
    ...
    try {
      ...
      onSuccess({
        ...
        groupsCreated: result.data.groupsCreated,
        processesCreated: result.data.processesCreated,
        replaceExisting,
      });
  ...
  }, [selectedFile, processMapId, replaceExisting, description, extractMutation, onSuccess, onOpenChange]);
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-full max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Uploadez une image contenant une carte de processus. L'IA analysera l'image et extraira automatiquement les groupes et processus.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            <Label>Image de la carte de processus</Label>
            {!selectedFile ? (
              <div
          ...
          <div className="space-y-2">
            ...
            <Textarea
              id="description"
              placeholder="Exemple: Carte des processus RH avec recrutement, formation et paie"
              value={description}
            ...
            <div className="flex items-start gap-2 p-3 bg-green-50 border border-green-200 rounded-lg">
              ...
              <div className="flex-1">
                ...
                <BodySmall className="text-green-600">
                  {extractMutation.data.data.groupsCreated} groupe(s) et{' '}
                  {extractMutation.data.data.processesCreated} processus extraits
                </BodySmall>
              </div>
            </div>
          )}
