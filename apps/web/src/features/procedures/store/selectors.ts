/**
 * Procedure Flow Store Selectors
...
import { useProcedureFlowStore } from './procedureFlowStore';
...
export const useNodes = () => {
  return useProcedureFlowStore((state) => state.nodes);
};
...
export const useEdges = () => {
  return useProcedureFlowStore((state) => state.edges);
};
...
export const useSelectedNodeIds = () => {
  return useProcedureFlowStore((state) => state.selectedNodeIds);
};
...
export const useSelectedEdgeIds = () => {
  return useProcedureFlowStore((state) => state.selectedEdgeIds);
};
...
export const useIsDirty = () => {
  return useProcedureFlowStore((state) => state.isDirty);
};
...
export const useLastSaved = () => {
  return useProcedureFlowStore((state) => state.lastSaved);
};

/**
 * Select Procedure ID
 */
export const useProcedureId = () => {
  return useProcedureFlowStore((state) => state.procedureId);
};
...
export const useViewport = () => {
  return useProcedureFlowStore((state) => state.viewport);
};
...
export const useActions = () => {
  return useProcedureFlowStore((state) => ({
    ...
    reset: state.reset,
    setProcedureId: state.setProcedureId,
