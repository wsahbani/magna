    ...
    <div className="space-y-6">
      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          <Heading2>Indicateurs de Performance</Heading2>
          {isEditable && (
            ...
            <div key={index} className="p-4 border border-gray-200 rounded-md">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateIndicator(index, 'targetValue', parseFloat(e.target.value))
                  }
                  disabled={!isEditable}
                />
                <input
                  ...
                  onChange={(e) =>
                    updateIndicator(index, 'currentValue', parseFloat(e.target.value))
                  }
                  disabled={!isEditable}
                />
                <select
      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          <Heading2>Acteurs et Responsabilités</Heading2>
          {isEditable && (
      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          <Heading2>Opportunités</Heading2>
          {isEditable && (
      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          <Heading2>Cibles de Performance</Heading2>
          {isEditable && (
