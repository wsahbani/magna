...
var CardTitle = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (_jsx("h3", __assign({ ref: ref, className: cn("text-lg sm:text-xl lg:text-2xl font-semibold leading-none tracking-tight", className) }, props)));
});
CardTitle.displayName = "CardTitle";
var CardDescription = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (_jsx("p", __assign({ ref: ref, className: cn("text-xs sm:text-sm text-muted-foreground", className) }, props)));
});
