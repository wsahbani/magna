...
var buttonVariants = cva("inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50", {
    variants: {
        variant: {
            ...
            // Orange Group Brand Variants
            orange: "bg-[#FF7900] text-white hover:bg-[#E66D00] active:bg-[#CC6100] shadow-sm",
            "orange-outline": "border-2 border-[#FF7900] text-[#FF7900] hover:bg-[#FFF5EB] active:bg-[#FFE6CC]",
            "orange-ghost": "text-[#FF7900] hover:bg-[#FFF5EB] hover:text-[#E66D00]",
            "black": "bg-black text-white hover:bg-gray-800 active:bg-gray-900 shadow-sm",
            "black-outline": "border-2 border-black text-black hover:bg-gray-100 active:bg-gray-200",
        },
        size: {
